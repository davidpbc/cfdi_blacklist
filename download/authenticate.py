...
class Authenticate():
    URL_AUTH = 'https://cfdidescargamasivasolicitud.clouda.sat.gob.mx/Autenticacion/Autenticacion.svc'
    ...
    def get_token(self):
        id_ = uuid.uuid4()
        soapreq = self.generate_soapreq(id_)
        ...
        response = requests.post(self.URL_AUTH, data=soapreq, headers=headers, verify=True)
